 ...
 *
 */
package org.bonstore.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('bonstorestorefront.generic.cms.component.controller.authorized.group')}")
