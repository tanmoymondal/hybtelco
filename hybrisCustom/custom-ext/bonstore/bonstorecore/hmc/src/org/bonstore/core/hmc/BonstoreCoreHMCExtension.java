...
/**
 * Provides necessary meta information about the bonstorecore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class BonstoreCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(BonstoreCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "org.bonstore.core.hmc.locales";
