 ...
 *  
 */
package org.bonstore.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(BonstoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(BonstoreFulfilmentProcessConstants.PARENT_PROCESS);
