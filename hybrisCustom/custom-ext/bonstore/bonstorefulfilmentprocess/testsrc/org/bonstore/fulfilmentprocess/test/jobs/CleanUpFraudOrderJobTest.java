 ...
 *  
 */
package org.bonstore.fulfilmentprocess.test.jobs;
...
import org.bonstore.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = BonstoreFulfilmentProcessConstants.ORDER_PROCESS_NAME;
