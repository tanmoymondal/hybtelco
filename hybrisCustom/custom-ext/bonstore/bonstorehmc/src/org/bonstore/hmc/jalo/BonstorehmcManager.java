...
/**
 * This is the extension manager of the Bonstorehmc extension.
 */
public class BonstorehmcManager extends GeneratedBonstorehmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BonstorehmcManager.class.getName());
	 ...
	 */
	public static BonstorehmcManager getInstance()
	{
		return (BonstorehmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BonstorehmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BonstorehmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BonstorehmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BonstorehmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BonstorehmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
