 ...
 *  
 */
package org.bonstore.test.setup;
...
import org.bonstore.test.constants.BonstoreTestConstants;
import org.bonstore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = BonstoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/bonstoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/bonstoretest/import/reviews.impex");
			...
			importImpexFile(context, "/bonstoretest/import/cstickets.impex");
		}
	}
}
